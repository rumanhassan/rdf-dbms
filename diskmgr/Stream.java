...
public class Stream implements GlobalConst{
	...
	private DB rdfdatabase;
	private int orderType;
	private String subjectFilter;
	private String predicateFilter;
	private String objectFilter;
	private double confidenceFilter;

    /** The TripleHeapFile we are using. */
    private TripleHeapFile  _thf;

    /** PageId of current directory page (which is itself a THFPage) */
     ...
     */
  public Stream(DB rdfDataBase, int orderType, String subjectFilter, 
		 String predicateFilter, String objectFilter, double confidenceFilter)
   ...
   * @return the Triple object with the specified TID.
   */
	   ...
	   IOException
  {
    ...
    try {
      recptrtriple = datapage.getTriple(tid);
    }
    ...
    /** Position the Stream cursor to the record with the given tid.
     * 
     * @exception InvalidTripleSizeException Invalid triple size
     * @exception IOException I/O errors
   ...
   * @exception InvalidTripleSizeException Invalid tuple size
   * @exception IOException I/O errors
   * @return true if successful
   *         false otherwise
   */
	   ...
	   IOException
  {
	...
	try {
          rectuple = dirpage.getTriple(datapageTid);
	}  
  ...
  private boolean peekNext(TID rid) {
    
    rid.pageNo.pid = usertid.pageNo.pid;
    rid.slotNo = usertid.slotNo;
    return true;
