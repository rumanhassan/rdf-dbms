...
public class Label implements GlobalConst{
 ...
 /** 
  ...
  /** 
   * private field
   * Number of fields in this label
   */
  ...
  public  Label()
  {
   ...
   /** Constructor
    * @param alabel a byte array which contains the label
   ...
   /** Constructor(used as label copy)
   ...
   /**  
    * Class constructor
    * Creat a new label with length = size,label offset = 0.
    */
  ...
  public  Label(int size)
  {
   ...
   /** Copy a label to the current label position
    *  you must make sure the label lengths must be equal
    * @param fromLabel the label being copied
    */
...
//       fldOffset = fromLabel.copyFldOffset(); 
 ...
 /**
  * Set a label with the given label length and offset
  * @param	record	a byte array contains the label
  ...
  *  call setHdr () before
  * @return 	length of this label in bytes
  */   
...
/** get the length of a label, call this method if you did 
  *  call setHdr () before
  * @return     size of this label in bytes
  */
  public short size()
   {
   ...
   /** Copy the label byte array out
    *  @return  byte[], a byte array contains the label
    *		the length of byte[] = length of the label
    */
    ...
    * @exception   FieldNumberOutOfBoundException Label field number out of bound
    */
   ...
   */
    ...
    * @param	types[]	  contains the types that will be in this label
    * @param	strSizes[]      contains the sizes of the string 
    *				
    * @exception IOException I/O errors
    * @exception InvalidTypeException Invalid tupe type
    * @exception InvalidLabelSizeException Label size too big
    *
    */

public void setHdr (short numFlds,  AttrType types[], short strSizes[])
 throws IOException, InvalidTypeException, InvalidLabelSizeException		
{
  if((numFlds +2)*2 > max_size)
    throw new InvalidLabelSizeException (null, "TUPLE: TUPLE_TOOBIG_ERROR");
 ...
 switch(types[numFlds -1].attrType) {
  ...
  /**
   * Returns number of fields in this label
   *
   * @return the number of fields in this label
   *
   */
 ...
 /**
  * Print out the label
  * @param type  the types in the label
