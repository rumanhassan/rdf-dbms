...
public class LabelUtils
{
   ...
   *@param    l1        one tuple.
   *@param    l2        another tuple.
   *@param    l1_fld_no the field numbers in the tuples to be compared.
   *@param    l2_fld_no the field numbers in the tuples to be compared. 
  ...
  /**
   *This function Compares two Tuple in all fields 
   * @param l1 the first tuple
   * @param l2 the secocnd tuple
  ...
  public static void SetValue(Label value, Label  label, int fld_no, AttrType fldType)
	...
	case AttrType.attrInteger:
	  try {
	    ...
	    throw new LabelUtilsException(e, "FieldNumberOutOfBoundException is caught by TupleUtils.java");
	  }
	  break;
