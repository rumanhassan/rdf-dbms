...
public class rdfDB implements GlobalConst {
	 ...
	 */
	/*
	 * Constructor creates triple heap file , label heap file and the Predicate
	 * heap file.
	 */
	public rdfDB(int type) throws THFException, THFBufMgrException,
			THFDiskMgrException, IOException, LHFException, LHFBufMgrException,
			LHFDiskMgrException {
	...
	/*
	 * this method gets the count of the triples in the Label Heap File and
	 * prints it in the report
	 */

	public int getTripleCnt() throws InvalidSlotNumberException,
			InvalidTupleSizeException, THFDiskMgrException, THFBufMgrException,
			IOException, InvalidTripleSizeException {
		return tripleHeapFile.getRecCnt();
	}

	/*
	 * This method gets the count of the Entities in the Label Heap File and
	 * prints it in the report
	 */
	public int getEntityCnt() throws labelheap.InvalidSlotNumberException,
			InvalidLabelSizeException, LHFDiskMgrException, LHFBufMgrException,
			IOException {
		return entityLabelHeapFile.getLabelCnt();
	}

	/*
	 * This method gets the count of the Predicate in the Label Heap File and
	 * prints it in the report
	 */
	public int getPredicateCnt() throws labelheap.InvalidSlotNumberException,
			InvalidLabelSizeException, LHFDiskMgrException, LHFBufMgrException,
			IOException {
	...
	/*
	 * this method gets the count of the subjects from the entity heap file.
	 */
	...
	/*
	 * Inserts the triple into the label heap file
	 */
	public TID insertTriple(byte[] recPtr) throws InvalidSlotNumberException,
			InvalidTupleSizeException, SpaceNotAvailableException,
			THFException, THFBufMgrException, THFDiskMgrException, IOException,
			InvalidTripleSizeException {
		return tripleHeapFile.insertTriple(recPtr);
	}

	/*
	 * Inserts the predicate into the label heap file
	 */
	public PID insertPredicate(byte[] recPtr)
			throws labelheap.InvalidSlotNumberException,
			InvalidLabelSizeException, labelheap.SpaceNotAvailableException,
			LHFException, LHFBufMgrException, LHFDiskMgrException, IOException {
		return (PID) entityLabelHeapFile.insertLabel(recPtr);
	}

	/*
	 * Inserts the entity into the label heap file
	 */
	public EID insertEntity(byte[] triplePtr)
			throws labelheap.InvalidSlotNumberException,
			InvalidLabelSizeException, labelheap.SpaceNotAvailableException,
			LHFException, LHFBufMgrException, LHFDiskMgrException, IOException {
	...
	/*
	 * Delete the entity from the label heap file
	 */
	...
	/*
	 * Delete the triple from the label heap file
	 */
	...
	public Stream openStream(int sortIndex, String subjectFilter,
		...
		Stream qStream = new Stream(rdfDB.rdfDatabase, sortIndex, subjectFilter,
...
class DBDirectoryPage extends DBHeaderPage {
	public static final int TripleCnt = 0;
